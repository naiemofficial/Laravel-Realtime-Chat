function executeDropMessage(data) {
    ...
    const last_sender_id        = Number(last_sender_element?.getAttribute('wire:key'));
    const messsage_sender_id    = Number(message.user_id);
    ...
    li.setAttribute('data-sender', ((messsage_sender_id === last_sender_id) ? 'self' : 'recipient'));
...
window.executeDropMessage = executeDropMessage;
